...
def main():
    ...
    print("2. MSc Proposed Framework: Extended with a custom RUL prediction head and physics-informed regularization.")
    print("   This extension adds only 2,081 additional parameters (67,202 total) and enables")
    print("   joint RUL sequence modeling with physical monotonicity protection.")
